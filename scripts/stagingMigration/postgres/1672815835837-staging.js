...
module.exports = class staging1672815835837 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "REL_76ba283779c8441fd5ff819c8c"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_settings" DROP CONSTRAINT "PK_e81f8bb92802737337d35c00981"`);
