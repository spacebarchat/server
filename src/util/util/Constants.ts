...
export const DiscordApiErrors = {
    ...
    get BOT_ONLY_ENDPOINT() {
        return new ApiError("Only bots can use this endpoint", 20002);
    },
    get EXPLICIT_CONTENT_CANNOT_BE_SENT_TO_RECIPIENT() {
        return new ApiError("Explicit content cannot be sent to the desired recipient(s)", 20009);
    },
    get ACTION_NOT_AUTHORIZED_ON_APPLICATION() {
        return new ApiError("You are not authorized to perform this action on this application", 20012);
    },
    get SLOWMODE_RATE_LIMIT() {
        return new ApiError("This action cannot be performed due to slowmode rate limit", 20016);
    },
    get ONLY_OWNER() {
        return new ApiError("Only the owner of this account can perform this action", 20018);
    },
    get ANNOUNCEMENT_RATE_LIMITS() {
        return new ApiError("This message cannot be edited due to announcement rate limits", 20022);
    },
    get CHANNEL_WRITE_RATELIMIT() {
        return new ApiError("The channel you are writing has hit the write rate limit", 20028);
    },
    get WORDS_NOT_ALLOWED() {
        return new ApiError("Your Stage topic, server name, server description, or channel names contain words that are not allowed", 20031);
    },
    get GUILD_PREMIUM_LEVEL_TOO_LOW() {
        return new ApiError("Guild premium subscription level too low", 20035);
    },
    get MAXIMUM_GUILDS() {
        return new ApiError("Maximum number of guilds reached ({})", 30001, undefined, ["100"]);
    },
    get MAXIMUM_FRIENDS() {
        return new ApiError("Maximum number of friends reached ({})", 30002, undefined, ["1000"]);
    },
    get MAXIMUM_PINS() {
        return new ApiError("Maximum number of pins reached for the channel ({})", 30003, undefined, ["50"]);
    },
    get MAXIMUM_NUMBER_OF_RECIPIENTS_REACHED() {
        return new ApiError("Maximum number of recipients reached ({})", 30004, undefined, ["10"]);
    },
    get MAXIMUM_ROLES() {
        return new ApiError("Maximum number of guild roles reached ({})", 30005, undefined, ["250"]);
    },
    get MAXIMUM_WEBHOOKS() {
        return new ApiError("Maximum number of webhooks reached ({})", 30007, undefined, ["10"]);
    },
    get MAXIMUM_NUMBER_OF_EMOJIS_REACHED() {
        return new ApiError("Maximum number of emojis reached", 30008);
    },
    get MAXIMUM_REACTIONS() {
        return new ApiError("Maximum number of reactions reached ({})", 30010, undefined, ["20"]);
    },
    get MAXIMUM_CHANNELS() {
        return new ApiError("Maximum number of guild channels reached ({})", 30013, undefined, ["500"]);
    },
    get MAXIMUM_ATTACHMENTS() {
        return new ApiError("Maximum number of attachments in a message reached ({})", 30015, undefined, ["10"]);
    },
    get MAXIMUM_INVITES() {
        return new ApiError("Maximum number of invites reached ({})", 30016, undefined, ["1000"]);
    },
    get MAXIMUM_ANIMATED_EMOJIS() {
        return new ApiError("Maximum number of animated emojis reached", 30018);
    },
    get MAXIMUM_SERVER_MEMBERS() {
        return new ApiError("Maximum number of server members reached", 30019);
    },
    get MAXIMUM_SERVER_CATEGORIES() {
        return new ApiError("Maximum number of server categories has been reached ({})", 30030, undefined, ["5"]);
    },
    get GUILD_ALREADY_HAS_TEMPLATE() {
        return new ApiError("Guild already has a template", 30031);
    },
    get MAXIMUM_THREAD_PARTICIPANTS() {
        return new ApiError("Max number of thread participants has been reached", 30033);
    },
    get MAXIMUM_BANS_FOR_NON_GUILD_MEMBERS() {
        return new ApiError("Maximum number of bans for non-guild members have been exceeded", 30035);
    },
    get MAXIMUM_BANS_FETCHES() {
        return new ApiError("Maximum number of bans fetches has been reached", 30037);
    },
    get MAXIMUM_STICKERS() {
        return new ApiError("Maximum number of stickers reached", 30039);
    },
    get MAXIMUM_PRUNE_REQUESTS() {
        return new ApiError("Maximum number of prune requests has been reached. Try again later", 30040);
    },
    get UNAUTHORIZED() {
    ...
    get REQUEST_ENTITY_TOO_LARGE() {
        return new ApiError("Request entity too large. Try sending something smaller in size", 40005);
    },
    get FEATURE_TEMPORARILY_DISABLED() {
        return new ApiError("This feature has been temporarily disabled server-side", 40006);
    },
    get USER_BANNED() {
        return new ApiError("The user is banned from this guild", 40007);
    },
    get CONNECTION_REVOKED() {
    ...
    get APPLICATION_COMMAND_ALREADY_EXISTS() {
    ...
    get CANNOT_EXECUTE_ON_DM() {
        return new ApiError("Cannot execute action on a DM channel", 50003);
    },
    get EMBED_DISABLED() {
    ...
    get MAXIMUM_OAUTH2_APPLICATIONS() {
        return new ApiError("OAuth2 application limit reached", 50011);
    },
    get INVALID_OAUTH_STATE() {
    ...
    get NOTE_TOO_LONG() {
        return new ApiError("Note was too long", 50015);
    },
    get INVALID_BULK_DELETE_QUANTITY() {
        return new ApiError("Provided too few or too many messages to delete. Must provide at least {} and fewer than {} messages to delete", 50016, undefined, ["2", "100"]);
    },
    get CANNOT_PIN_MESSAGE_IN_OTHER_CHANNEL() {
        return new ApiError("A message can only be pinned to the channel it was sent in", 50019);
    },
    get INVALID_OR_TAKEN_INVITE_CODE() {
        return new ApiError("Invite code was either invalid or taken", 50020);
    },
    get CANNOT_EXECUTE_ON_SYSTEM_MESSAGE() {
        return new ApiError("Cannot execute action on a system message", 50021);
    },
    get CANNOT_EXECUTE_ON_THIS_CHANNEL_TYPE() {
        return new ApiError("Cannot execute action on this channel type", 50024);
    },
    get INVALID_OAUTH_TOKEN() {
        return new ApiError("Invalid OAuth2 access token provided", 50025);
    },
    get MISSING_REQUIRED_OAUTH2_SCOPE() {
    ...
    get INVALID_RECIPIENT() {
        return new ApiError("Invalid Recipient(s)", 50033);
    },
    get BULK_DELETE_MESSAGE_TOO_OLD() {
        return new ApiError("A message provided was too old to bulk delete", 50034);
    },
    get INVALID_FORM_BODY() {
        return new ApiError("Invalid form body (returned for both application/json and multipart/form-data bodies), or invalid Content-Type provided", 50035);
    },
    get INVITE_ACCEPTED_TO_GUILD_NOT_CONTAINING_BOT() {
        return new ApiError("An invite was accepted to a guild the application's bot is not in", 50036);
    },
    get INVALID_API_VERSION() {
        return new ApiError("Invalid API version provided", 50041);
    },
    get FILE_EXCEEDS_MAXIMUM_SIZE() {
        return new ApiError("File uploaded exceeds the maximum size", 50045);
    },
    get INVALID_FILE_UPLOADED() {
        return new ApiError("Invalid file uploaded", 50046);
    },
    ...
    get CANNOT_DELETE_COMMUNITY_REQUIRED_CHANNEL() {
        return new ApiError("Cannot delete a channel required for Community guilds", 50074);
    },
    get INVALID_STICKER_SENT() {
        return new ApiError("Invalid sticker sent", 50081);
    },
    get CANNOT_EDIT_ARCHIVED_THREAD() {
        return new ApiError("Tried to perform an operation on an archived thread, such as editing a message or adding a user to the thread", 50083);
    },
    get INVALID_THREAD_NOTIFICATION_SETTINGS() {
        return new ApiError("Invalid thread notification settings", 50084);
    },
    get BEFORE_EARLIER_THAN_THREAD_CREATION_DATE() {
        return new ApiError("before value is earlier than the thread creation date", 50085);
    },
    get SERVER_NOT_AVAILABLE_IN_YOUR_LOCATION() {
        return new ApiError("This server is not available in your location", 50095);
    },
    get SERVER_NEEDS_MONETIZATION_ENABLED() {
        return new ApiError("This server needs monetization enabled in order to perform this action", 50097);
    },
    ...
    get REACTION_BLOCKED() {
        return new ApiError("Reaction was blocked", 90001);
    },
    get RESOURCE_OVERLOADED() {
        return new ApiError("API resource is currently overloaded. Try again a little later", 130000);
    },
    get STAGE_ALREADY_OPEN() {
        return new ApiError("The Stage is already open", 150006);
    },
    get THREAD_ALREADY_CREATED_FOR_THIS_MESSAGE() {
        return new ApiError("A thread has already been created for this message", 160004);
    },
    get THREAD_IS_LOCKED() {
        return new ApiError("Thread is locked", 160005);
    },
    get MAXIMUM_NUMBER_OF_ACTIVE_THREADS() {
        return new ApiError("Maximum number of active threads reached", 160006);
    },
    get MAXIMUM_NUMBER_OF_ACTIVE_ANNOUNCEMENT_THREADS() {
        return new ApiError("Maximum number of active announcement threads reached", 160007);
    },
    get INVALID_JSON_FOR_UPLOADED_LOTTIE_FILE() {
        return new ApiError("Invalid JSON for uploaded Lottie file", 170001);
    },
    get LOTTIES_CANNOT_CONTAIN_RASTERIZED_IMAGES() {
        return new ApiError("Uploaded Lotties cannot contain rasterized images such as PNG or JPEG", 170002);
    },
    get STICKER_MAXIMUM_FRAMERATE() {
        return new ApiError("Sticker maximum framerate exceeded", 170003);
    },
    get STICKER_MAXIMUM_FRAME_COUNT() {
        return new ApiError("Sticker frame count exceeds maximum of {} frames", 170004, undefined, ["1000"]);
    },
    get LOTTIE_ANIMATION_MAXIMUM_DIMENSIONS() {
        return new ApiError("Lottie animation maximum dimensions exceeded", 170005);
    },
    get STICKER_FRAME_RATE_TOO_SMALL_OR_TOO_LARGE() {
        return new ApiError("Sticker frame rate is either too small or too large", 170006);
    },
    get STICKER_ANIMATION_DURATION_MAXIMUM() {
        return new ApiError("Sticker animation duration exceeds maximum of {} seconds", 170007, undefined, ["5"]);
    },
    get AUTOMODERATOR_BLOCK() {
        return new ApiError("Message was blocked by automatic moderation", 200000);
    },
    get BULK_BAN_FAILED() {
        return new ApiError("Failed to ban users", 500000);
    },
    get POLL_VOTING_BLOCKED() {
        return new ApiError("Poll voting blocked", 520000);
    },
    get POLL_EXPIRED() {
        return new ApiError("Poll expired", 520001);
    },
    get POLL_INVALID_CHANNEL_TYPE() {
        return new ApiError("Invalid channel type for poll creation", 520002);
    },
    get POLL_CANNOT_EDIT_MESSAGE() {
        return new ApiError("Cannot edit a poll message", 520003);
    },
    get NON_POLL_MESSAGE_CANNOT_EXPIRE() {
        return new ApiError("Cannot expire a non-poll message", 520006);
    },

    //Other errors
    get UNKNOWN_VOICE_STATE() {
        return new ApiError("Unknown Voice State", 10065, 404);
    },
};
